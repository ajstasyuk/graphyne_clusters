...
1. Run graphyne structure analysis (Stage 1: graphyne_analyzer.py)
2. Generate graphyne triangle clusters (Stage 2: triangle_cluster_generator.py)
3. Process and deduplicate RDKit structures (Stage 3: graphyne_cluster_processor.py)
4. Add hydrogens to final unique clusters (Stage 4: hydrogen_adder.py)

Usage:
    python3 main.py -n inpup_structure.xyz -c 8 -o output_dir_name
